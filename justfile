...
schema:
    ...
    quicktype --lang cs --src-lang schema -t CommandSequence --namespace Dreamcaller.Schema --csharp-version 6 --array-type list --features complete --check-required -o client/Assets/Dreamcaller/Schema/Schema.cs schema.json
    rm schema.json
