...
code-review-worktree:
    ./scripts/review/review_in_worktree.sh
...
stress-test *args='':
    cargo run --manifest-path rules_engine/Cargo.toml --release --bin run_matchup -- '{"MonteCarlo":50}' '{"MonteCarlo":50}' --stress --deck core11 "$@"
