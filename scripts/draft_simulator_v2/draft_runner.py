"""Draft runner v2: round orchestration and full draft execution.

v2 changes: removed all refill logic. Card loading via
load_cards(). Cube always copies_per_card=1, without_replacement.
