...
threshold: 3 slots outperforms 2 by 0.2-0.4 S/A. Lower threshold increases surge
frequency from 39% (T=6) to 64% (T=4).
...
pulse is the algorithm's signature -- genuine valleys between peaks. Lane
Locking is unimodal at 2 (stddev 0.77, fails >= 0.8 target).

## Comparison to Agent 1 Baselines

**vs Lane Locking:** Surge T=4/S=3 crosses 2.0 (2.08 vs 1.83), converges 3 picks
faster, nearly doubles variance, and achieves proper deck concentration.

**vs Pack Widening:** Hit 3.35 S/A in V4 but required spending decisions. Surge
achieves 2.08 with zero decisions -- lower but fully passive.
...
**Trace 3 (Signal reader, Self-Discard):** Stone tokens accumulate fast from 2-3
symbol picks. Surges fire every other pick. 15 surges total. Surge packs
...
post-commitment creates rhythm without being mechanical. Symbol distribution: 36
generic, 80 mono-1, 134 mono-2, 54 dual-2 (15% cap), 56 mono-3.
