...
## Tempo
Primarily **Arc + Ignite**, secondarily **Arc + Surge** and some **Rime + Surge**.
...
- Without Rime, Umbra recurs well but loads the void too slowly and too
  bluntly.
...
**Core idea:**
Bloom creates more dreamstuff than everyone else.
...
**Core idea:**
Arc makes state changes worth repeating.
...
**Core idea:**
Power comes from things materializing over and over.
...
**Core idea:**
Loss should be converted into advantage.
...
**Core idea:**
The void is a reusable operating zone.
...
**Core idea:**
Cards are worth more when you put them in the right place.
...
**Core idea:**
Momentum comes from chaining actions until they avalanche.
...
A tide should be recognizable.
A tide should be coherent.
A tide should be powerful.
