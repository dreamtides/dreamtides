...
fn children_command_succeeds_with_no_children() {
    ...
    insert_root(env.conn(), "api", "LAABCD", 0);
...
fn children_command_lists_task_children() {
    ...
    insert_doc(env.conn(), &root_doc, env.repo_root(), "api/api.md");
    insert_root(env.conn(), "api", "LBBCDE", 0);
    ...
    insert_doc(env.conn(), &task2, env.repo_root(), "api/tasks/task2.md");
...
fn children_command_lists_docs_children() {
    ...
    insert_doc(env.conn(), &root_doc, env.repo_root(), "api/api.md");
    insert_root(env.conn(), "api", "LEGHIJ", 0);
...
fn children_command_lists_mixed_children() {
    ...
    insert_doc(env.conn(), &root_doc, env.repo_root(), "api/api.md");
    insert_root(env.conn(), "api", "LGIJKL", 0);
...
fn children_command_non_recursive_excludes_nested() {
    ...
    insert_doc(env.conn(), &root_doc, env.repo_root(), "api/api.md");
    insert_root(env.conn(), "api", "LQSTUV", 0);
    ...
    insert_doc(env.conn(), &auth_root, env.repo_root(), "api/auth/auth.md");
...
fn children_command_recursive_includes_nested() {
    ...
    insert_doc(env.conn(), &root_doc, env.repo_root(), "api/api.md");
    insert_root(env.conn(), "api", "LUWXYZ", 0);
...
fn children_command_fails_for_non_root_document() {
    ...
    insert_doc(env.conn(), &root_doc, env.repo_root(), "api/api.md");
    insert_root(env.conn(), "api", "LYABCD", 0);
...
fn children_command_includes_closed_tasks() {
    ...
    insert_doc(env.conn(), &root_doc, env.repo_root(), "api/api.md");
    insert_root(env.conn(), "api", "LAADEF", 0);

    let open_task =
        create_task_doc("LABEFG", "LAADEF", "api/tasks/open.md", "open-task", "Open task");
    insert_doc(env.conn(), &open_task, env.repo_root(), "api/tasks/open.md");

    let closed_task =
        create_task_doc("LACFGH", "LAADEF", "api/tasks/.closed/done.md", "done-task", "Done task");
    insert_doc(env.conn(), &closed_task, env.repo_root(), "api/tasks/.closed/done.md");
...
fn children_command_json_output() {
    ...
    insert_doc(env.conn(), &root_doc, env.repo_root(), "api/api.md");
    insert_root(env.conn(), "api", "LADGHI", 0);
