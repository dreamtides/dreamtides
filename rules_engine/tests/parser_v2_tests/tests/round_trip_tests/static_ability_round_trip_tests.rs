...
fn test_opponent_events_cost_more() {
    assert_round_trip("The opponent's events cost {energy(e)} more.", "e: 1");
}
...
fn test_characters_cost_less() {
    assert_round_trip("Characters cost you {energy(e)} less.", "e: 2");
}

#[test]
fn test_events_cost_less() {
    assert_round_trip("Events cost you {energy(e)} less.", "e: 1");
}
