...
updated-at: 2026-01-20T07:05:43.152959Z
---
...
## Analysis
The check seems to only recognize files directly in `docs/` or `tasks/` but not in subdirectories like `docs/design/` or `docs/api/`.