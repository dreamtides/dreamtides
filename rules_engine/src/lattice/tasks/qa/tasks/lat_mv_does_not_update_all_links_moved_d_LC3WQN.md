...
updated-at: 2026-01-21T22:31:38.571365Z
---
...
2. Create endpoints.md linking to architecture: `
   [architecture doc](../design/architecture.md#LBVWQN) `
3. Create data_model.md also linking to architecture: `
   [link](architecture.md#LBVWQN) `
4. Run `lat mv LBVWQN docs/new_location/architecture.md`

## Expected Behavior

Both endpoints.md and data_model.md should have their links updated to point to
the new location.
...
- endpoints.md: `../design/architecture.md#LBVWQN` ✗ (should be
  `../new_location/architecture.md#LBVWQN`)
...
This is likely the same root cause as the backlink tracking bug - endpoints.md
was also not shown by `lat links-to LBVWQN`.
