...
updated-at: 2026-01-21T22:31:38.558829Z
---
...
- Link ` [architecture doc](LTEST01) ` should expand to `
  [architecture doc](../design/architecture.md#LTEST01) `
- Link ` [endpoints](../api/endpoints.md) ` should get `#LTEST02` fragment
  appended
...
- `lat fmt` output says "2 file(s) formatted, 1 unchanged" but files with
  shorthand links were not modified
...
The files containing shorthand links (`docs/api/endpoints.md` and
`docs/design/data_model.md`) were not formatted.
