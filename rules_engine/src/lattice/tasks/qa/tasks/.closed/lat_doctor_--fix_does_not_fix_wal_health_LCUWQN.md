...
updated-at: 2026-01-21T22:31:38.540908Z
...
- `lat doctor` reports: `WAL Health: WAL corruption detected` with message "WAL
  file has unusual size (3411392 bytes)"
...
- "Corruption" seems like a strong term for a large WAL file - this may just
  need checkpointing
- Two potential issues: (1) WAL not being checkpointed during normal use, (2)
  --fix not implementing the fix
