...
fn dispatch_command(_context: CommandContext, command: Command) -> LatticeResult<()> {
    match command {
        ...
        Command::Create(_args) => {
            ...
            Err(LatticeError::OperationNotAllowed {
                reason: "create command not yet implemented".to_string(),
            })
        }
        ...
        Command::Close(_args) => {
            ...
            Err(LatticeError::OperationNotAllowed {
                reason: "close command not yet implemented".to_string(),
            })
        }
        ...
        Command::Ready(_args) => {
            ...
            Err(LatticeError::OperationNotAllowed {
                reason: "ready command not yet implemented".to_string(),
            })
        }
        ...
        Command::Changes(_args) => {
            ...
            Err(LatticeError::OperationNotAllowed {
                reason: "changes command not yet implemented".to_string(),
            })
        }
        Command::Stats(_args) => {
        ...
        Command::Tree(_args) => {
            ...
            Err(LatticeError::OperationNotAllowed {
                reason: "tree command not yet implemented".to_string(),
            })
        }
        Command::Roots(_args) => {
