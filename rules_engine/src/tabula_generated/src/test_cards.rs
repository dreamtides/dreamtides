...
/// When you play a card during the opponent's turn, this character gains +{s}
/// spark.
...
/// {ChooseOne} {bullet} {mode1-cost}: Return an enemy character to hand.
...
/// {ChooseOne} {bullet} {mode1-cost}: Draw {cards1}. {bullet} {mode2-cost}:
/// Draw {cards2}.
pub const TEST_MODAL_DRAW_ONE_OR_DRAW_TWO: BaseCardId =
    BaseCardId(uuid!("029889e9-25bc-438f-a492-8813febd65d8"));
/// {ChooseOne} {bullet} {mode1-cost}: Draw {cards}. {bullet} {mode2-cost}:
/// {Dissolve} an enemy character.
