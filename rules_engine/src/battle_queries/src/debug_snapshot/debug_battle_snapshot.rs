...
fn debug_all_cards(battle: &BattleState) -> DebugAllCards {
    DebugAllCards {
        p1_battlefield: debug_zone(
            ...
            Zone::Battlefield,
            PlayerName::One,
            battle.cards.battlefield(PlayerName::One).iter().map(|id| CardId(id)),
        ),
        p2_battlefield: debug_zone(
            battle,
            Zone::Battlefield,
            PlayerName::Two,
            battle.cards.battlefield(PlayerName::Two).iter().map(|id| CardId(id)),
        ),
        p1_void: debug_zone(
            battle,
            Zone::Void,
            PlayerName::One,
            battle.cards.void(PlayerName::One).iter().map(|id| CardId(id)),
        ),
        p2_void: debug_zone(
            battle,
            Zone::Void,
            PlayerName::Two,
            battle.cards.void(PlayerName::Two).iter().map(|id| CardId(id)),
        ),
        p1_hand: debug_zone(
            battle,
            Zone::Hand,
            PlayerName::One,
            battle.cards.hand(PlayerName::One).iter().map(|id| CardId(id)),
        ),
        p2_hand: debug_zone(
            battle,
            Zone::Stack,
        ...
        p1_deck: debug_zone(
            ...
            Zone::Deck,
            PlayerName::One,
            battle.cards.deck(PlayerName::One).iter().map(|id| CardId(id)),
        ),
        p2_deck: debug_zone(
            battle,
            Zone::Deck,
            PlayerName::Two,
            battle.cards.deck(PlayerName::Two).iter().map(|id| CardId(id)),
        ),
        stack: debug_zone(
            battle,
            Zone::Stack,
        ...
        p1_banished: debug_zone(
            ...
            Zone::Banished,
            PlayerName::One,
            battle.cards.banished(PlayerName::One).iter().map(|id| CardId(id)),
        ),
        p2_banished: debug_zone(
            battle,
            Zone::Banished,
            PlayerName::Two,
            battle.cards.banished(PlayerName::Two).iter().map(|id| CardId(id)),
        ),
    }
}
