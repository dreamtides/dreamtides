...
pub fn get_character_target_predicate(effect: &StandardEffect) -> Option<&Predicate> {
    match effect {
        ...
        StandardEffect::EachPlayerShufflesHandAndVoidIntoDeckAndDraws { .. } => None,
        ...
        StandardEffect::TriggerAdditionalDawnPhaseAtEndOfTurn => None,
        StandardEffect::TriggerDawnAbility { .. } => None,
