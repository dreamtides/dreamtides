...
- build-xls: rewrites data columns and leaves formulas intact, dry-run leaves file unchanged, auto-adds/removes rows at the bottom to match TOML, errors on unknown columns, supports single-column array input.
