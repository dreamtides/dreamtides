...
pub fn dreamwell_card_id_list(list: DreamwellCardIdList) -> &'static [DreamwellCardDefinitionId] {
    match list {
...
pub const TEST_DREAMWELL_BASIC_5: &[DreamwellCardDefinitionId] = &[
...
pub const TEST_DREAMWELL_NO_ABILITIES: &[DreamwellCardDefinitionId] = &[
    DreamwellCardDefinitionId(uuid!("308fd4c0-ca98-4bfa-a9be-c29b36a145fd")),
    DreamwellCardDefinitionId(uuid!("308fd4c0-ca98-4bfa-a9be-c29b36a145fd")),
