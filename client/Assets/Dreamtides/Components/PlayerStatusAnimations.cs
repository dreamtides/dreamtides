...
namespace Dreamtides.Components
{
  public class PlayerStatusAnimations : MonoBehaviour
  {
    ...
    readonly List<AnimationConfig> _animations = new()
    {
      new AnimationConfig
      {
        EnterAnimation = "IDL_ArmsFolded_Casual_Enter",
        MainAnimation = "IDL_ArmsFolded_Casual_Loop",
        ExitAnimation = "IDL_ArmsFolded_Casual_Exit",
        IsLooping = true,
      },
      ...
      new AnimationConfig
      {
        EnterAnimation = "IDL_HandsOnHips_Base_Enter",
        MainAnimation = "IDL_HandsOnHips_Base_Loop",
        ExitAnimation = "IDL_HandsOnHips_Base_Exit",
        IsLooping = true,
      },
      ...
      new AnimationConfig
      {
        EnterAnimation = "IDL_Lean_B_Base_Enter",
        MainAnimation = "IDL_Lean_B_Base_Loop",
        ExitAnimation = "IDL_Lean_B_Base_Exit",
        IsLooping = true,
      },
      new AnimationConfig
      {
        EnterAnimation = "IDL_Lean_L_Base_Enter",
        MainAnimation = "IDL_Lean_L_Base_Loop",
        ExitAnimation = "IDL_Lean_L_Base_Exit",
        IsLooping = true,
      },
      ...
      new AnimationConfig
      {
        EnterAnimation = "IDL_Posture_Aggressive_Enter",
        MainAnimation = "IDL_Posture_Aggressive_Loop",
        ExitAnimation = "IDL_Posture_Aggressive_Exit",
        IsLooping = true,
      },
      new AnimationConfig
      {
        EnterAnimation = "IDL_Idles_Posture_Slumped_Enter",
        MainAnimation = "IDL_Idles_Posture_Slumped_Loop",
        ExitAnimation = "IDL_Idles_Posture_Slumped_Exit",
        IsLooping = true,
      },
    ...
    float GetCurrentAnimationDuration()
    {
      ...
      if (subject == null)
      {
        _registry.LoggingService.LogError(
          nameof(PlayerStatusAnimations),
